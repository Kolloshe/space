...
Future<PlayerData> getPlayerData() async{
 ...
 final playerData=  box.get(PlayerData.PLAYER_DATA_KEY);
  if(playerData == null){
   box.put(PlayerData.PLAYER_DATA_KEY, PlayerData.fromMap(PlayerData.defaultData));
  }
...
Future<Settings> getSettings() async{
  ...
  if(settings == null){
    box.put(Settings.SETTINGS_KEY,Settings(soundEffects: true,backgroundMusic: true));
  }
